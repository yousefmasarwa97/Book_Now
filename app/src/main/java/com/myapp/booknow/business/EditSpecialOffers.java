...
//            @Override
//            public void onClick(View v) {
//                Intent show = new Intent(EditSpecialOffers.this, BusinessDashboardActivity.class);
//                startActivity(show);
//            }
//        });
//        backButton.setOnClickListener(new View.OnClickListener() {
...
////                                Intent intent = new Intent(EditSpecialOffers.this, BusinessDashboardActivity.class);
...
////                    Toast.makeText(EditSpecialOffers.this, "Service edited successfully", Toast.LENGTH_SHORT).show();
////                },
////                e -> {
////                    // Failure handling
////                    Toast.makeText(EditSpecialOffers.this, "Failed to edit service info", Toast.LENGTH_SHORT).show();
////                });
////    }
////
